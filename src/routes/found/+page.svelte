...
<svelte:head>
  <title>Ishakiro - Report Found Item</title>
</svelte:head>

<div class="max-w-3xl mx-auto relative">
  <!-- Background Effects -->
  <div class="absolute inset-0 overflow-hidden pointer-events-none -z-10">
    <div class="absolute top-0 left-0 w-72 h-72 bg-green-200/30 rounded-full blur-3xl floating"></div>
    <div class="absolute bottom-0 right-0 w-72 h-72 bg-emerald-200/30 rounded-full blur-3xl floating" style="animation-delay: 1s;"></div>
  </div>

  <div class="glass-card">
    <!-- Header -->
    <div class="text-center mb-10">
      <div class="inline-block p-6 bg-gradient-to-br from-green-500 to-emerald-600 rounded-3xl shadow-2xl mb-6 transform hover:rotate-6 transition-transform duration-300">
      ...
      <p class="text-xl text-gray-600">Help reunite someone with their lost item</p>
    </div>
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
          ...
          <textarea
            ...
            placeholder="Describe the found item in detail... Help the owner identify it!"
          ></textarea>
        </div>
